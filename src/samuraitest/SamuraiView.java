...
public class SamuraiView extends Pane{
	...
	private void setflip(int flip){
		this.flip = flip;
		this.setScaleX(flip);
		missText.setScaleX(flip);
		attackedText.setScaleX(flip);
	}
	...
	public void setMiss(int direction){
		Timeline missTL= new Timeline(
				...
				new KeyFrame(Duration.millis(300), new KeyValue(group.layoutXProperty(), -40*SCALE*back, Interpolator.EASE_IN)),
