...
public class InformationLibrary implements Serializable {
	...
	public void initialize() {
		...
		informationLibraries.add(new Information(820, "鹅卵石", "820"));
		informationLibraries.add(new Information(821, "圆石", "821"));
		informationLibraries.add(new Information(822, "乌金石", "822"));
		informationLibraries.add(new Information(823, "黑曜石", "823"));
		informationLibraries.add(new Information(830, "铸铁", "830"));
		informationLibraries.add(new Information(831, "青铜", "831"));
		informationLibraries.add(new Information(832, "月之银", "832"));
		informationLibraries.add(new Information(833, "日之金", "833"));
