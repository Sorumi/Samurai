...
public class GuidePanel5 extends GuidePanel{
	...
	public GuidePanel5(){
		...
		explainLabel2.setLayoutY(250);
		explainLabel2.setPrefSize(1000, 100);
		...
		explainLabel3.setLayoutY(350);
		explainLabel3.setPrefSize(1000, 100);
		explainLabel3.setId("explain-label");
	
		explainLabel4 = new Label("只有完成了之前关卡的简单模式才能进入下一个关卡。");
		explainLabel4.setLayoutX(50);
		explainLabel4.setLayoutY(450);
