...
public class GuidePanel2 extends GuidePanel {
	...
	public GuidePanel2() {
		...
		explainLabel1.setLayoutX(130);
		explainLabel1.setLayoutY(107);
		explainLabel1.setPrefSize(900, 100);
		explainLabel1.setId("explain-label");

		explainLabel2 = new Label("移动：消耗两个行动点，可以向武士的周围空格移动一步。");
		explainLabel2.setLayoutX(130);
		explainLabel2.setLayoutY(255);
		...
		for (int num = 0; num <= 2; num++) {
			...
			action_btn.setLayoutX(50);
			action_btn.setLayoutY(120 + 100 * num);
