...
//		updateMap(5);
	...
	public class LandButton extends Button {
		...
		public LandButton(int num) {
			...
			switch (num) {
			case 0:
				imgV.setFitWidth(313);
				break;
			case 1:
				imgV.setFitWidth(294);
				break;
			case 2:
				imgV.setFitWidth(294);
				break;
			case 3:
				imgV.setFitWidth(302);
				break;
			case 4:
				imgV.setFitWidth(284);
				break;
			case 5:
				imgV.setFitWidth(287);
				break;
			}
		...
		public void setFade() {
			...
			for (int i = 0; i < this.getChildren().size(); i++) {
				if (i % 2 == 0) {
					...
					tl.getKeyFrames().add(new KeyFrame(Duration.millis(3000),
							new KeyValue(fog.layoutXProperty(), -fog.getFitWidth())));
				} else {
					ImageView fog = (ImageView) this.getChildren().get(i);
					tl.getKeyFrames()
							.add(new KeyFrame(Duration.millis(3000), new KeyValue(fog.layoutXProperty(), 1200)));
				}
			}
			tl.play();
		}
